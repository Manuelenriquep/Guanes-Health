# ÚNICA FUENTE DE VERDAD (SSOT): MAPA DE ARQUITECTURA Y LIMITACIONES BIOLÓGICAS (v2.0)
...
5.  **Placa Lógica Inmunológica (CD8+ TILs)**: Modela el microambiente inmunitario del estroma. Define la sensibilidad enzimática de los linfocitos infiltrantes y su desactivación por desgranulación fallida ante un pH extracelular local inferior o igual a 6.50 (Veto del Escudo Ácido) [21].
...
*   **[RESOLVED-B-01] Paratopos de Interferencia Soluble (sGPC3)**: 
    ...
    *   *Verificación*: `test_cart_hcc_interaccion.py::test_senuelo_sgpc3_resolved_b`. Escape tumoral parcial por saturación en fase líquida bajo control de calidad del arnés [20].
...
---
*Fin de la Especificación Técnica SSoT v2.0. Guanes Health, 2026.*
